...
},{}],"src/models/Eventings.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Eventings = void 0;
...
var Eventings_1 = require("./Eventings");
...
function () {
  function Collection(rootUrl, deserialize) {
    ...
    this.models = [];
    this.events = new Eventings_1.Eventings();
  }
...
},{"axios":"node_modules/axios/index.js","./Eventings":"src/models/Eventings.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (data) {
    return new User(new Eventings_1.Eventings(), new ApiSync_1.ApiSync(rootUrl), new Attributes_1.Attributes(data));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Eventings":"src/models/Eventings.ts","./Collection":"src/models/Collection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  View.prototype.eventMaps = function () {
    return {};
  };
...
function (_super) {
  ...
  UserForm.prototype.eventMaps = function () {
    return {
