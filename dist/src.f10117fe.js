...
exports.User = User;
},{"./Eventings":"src/models/Eventings.ts","./Sync":"src/models/Sync.ts","./Attributes":"src/models/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
user.on('click', function () {
  return console.log('Click function');
});
user.set({
  name: "Kratos"
});
